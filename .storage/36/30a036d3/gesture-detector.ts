...
export const detectGesture = (landmarks: Landmarks): string => {
  ...
  if (
    indexKnuckleDist < 0.45 * indexWristDist &&
    middleKnuckleDist < 0.45 * middleWristDist &&
    ringKnuckleDist < 0.45 * ringWristDist &&
    pinkyKnuckleDist < 0.45 * pinkyWristDist &&
    // Modified thumb condition for better detection
    calculateDistance(thumbTip, indexKnuckle) < 0.5 * indexWristDist &&
    indexAngle > 60 &&
    middleAngle > 60 &&
    ringAngle > 60 &&
    pinkyAngle > 60

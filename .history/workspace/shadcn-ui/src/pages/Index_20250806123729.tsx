...
export default function GestureControlApp() {
  ...
  <div className="text-[60px]">🖐️</div> // Open hand
)}
{gesture === 'closed_palm' && (
  <div className="text-[60px]">✊</div> // Closed fist
)}
      ...
      <main className="flex-1 p-4 flex flex-col items-center">
        ...
        <div className="mt-8 w-full max-w-2xl">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div className={`p-3 bg-white rounded-lg shadow text-center transition-all ${detectedGesture === 'closed_palm' ? 'ring-2 ring-green-500 scale-105 gesture-highlight' : ''}`}>
              <p className="text-3xl">✊</p>
              <p className="mt-1">Closed Palm</p>
            </div>

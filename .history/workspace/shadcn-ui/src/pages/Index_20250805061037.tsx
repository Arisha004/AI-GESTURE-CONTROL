            ...
            if (hand.length > 0) {
              ...
              if (gesture !== detectedGesture) {
                ...
                if (gesture === 'thumbs_up') {
                  ...
                  setFeedback({
                    message: "Open palm mode activated",
                    visible: true
                  });
      ...
      <main className="flex-1 p-4 flex flex-col items-center">
        ...
        <div className="mt-8 w-full max-w-2xl">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div className={`p-3 bg-white rounded-lg shadow text-center transition-all ${detectedGesture === '   <div className={`p-3 bg-white rounded-lg shadow text-center transition-all ${detectedGesture === 'peace' ? 'ring-2 ring-green-500 scale-105 gesture-highlight' : ''}`}>
              <p className="text-3xl">✌️</p>
              <p className="mt-1">Peace Sign</p>
            </div>
         ' ? 'ring-2 ring-green-500 scale-105 gesture-highlight' : ''}`}>
              <p className="text-3xl">👊</p>
